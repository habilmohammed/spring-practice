...
import com.rdalabs.database.databasedemo.springdata.PersonSpringDataRepository;
...
public class SpringDataDemoApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		LOGGER.info("insert a row -> {}", dao.save(new Person("row 2", "location 2", new Date())));
		LOGGER.info("insert a row -> {}", dao.save(new Person("row 3", "location 3", new Date())));
		LOGGER.info("update 1st row -> {}", dao.save(new Person(10001,"row 1", "location 1", new Date())));
