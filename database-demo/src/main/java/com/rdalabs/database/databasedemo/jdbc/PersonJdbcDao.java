...
public class PersonJdbcDao {
	...
	public List<Person> findAll() {
		return jdbcTemplate.query(
				"select * from person", 
				new BeanPropertyRowMapper<Person>(Person.class) // using default row mapper, if the fields match this can be used.
		);
	}
	...
	public Person findById(int id) {
		return jdbcTemplate.queryForObject(
				...
				new Object[] {id},
				new PersonRowMapper() // using custom row mapper, if the values do not match custom row mapper should be used.
		);
	}
